...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
      ...
      <div className="rounded-full border-[#3333] h-[500px] w-[500px] mt-52 absolute" />
      <div className="rounded-full border border-[#3333] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse" />
